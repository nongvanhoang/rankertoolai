---
name: rankertoolai-seo
description: Optimizes meta tags, heading structure, schema.org JSON-LD, canonical/OG tags, and image alt text on an existing HTML page. Use after a writer agent produces a page, before internal-linking/qa.
