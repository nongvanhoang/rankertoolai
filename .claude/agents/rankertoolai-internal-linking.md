---
name: rankertoolai-internal-linking
description: Adds internal cross-links to a new page and updates existing pages to link back to it. Use after rankertoolai-seo, before rankertoolai-qa.
