...
See `.claude/AGENT_CONVENTIONS.md` for the shared rules (affiliate link format, disclosure block, no fabrication, schema shape) — all of it applies here. Comparison-specific on top of that:
