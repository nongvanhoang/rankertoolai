...
<div class="panel" id="tab-analytics">
  <div style="margin-bottom:1rem;padding:1rem;background:rgba(99,102,241,0.06);border:1px solid rgba(99,102,241,0.2);border-radius:10px;font-size:0.82rem;color:#94a3b8">
    Analytics data requires Google account login. Click the links below to open live dashboards — they open in a new tab.
  </div>
  <div class="link-grid">
    <div class="link-card">
      <a href="https://analytics.google.com/analytics/web/#/p{'{GA4_PROPERTY_ID}'}/reports/home" target="_blank">Google Analytics 4 →</a>
      <p>Sessions, users, pageviews, events. Property ID: G-81KB8ECCVF. Check real-time tab for live visitors.</p>
    </div>
    <div class="link-card">
      <a href="https://search.google.com/search-console/performance/search-analytics" target="_blank">Google Search Console →</a>
      <p>Impressions, clicks, average position, CTR. Filter by page to see ranking keywords per review.</p>
    </div>
    <div class="link-card">
      <a href="https://dash.cloudflare.com" target="_blank">Cloudflare Analytics →</a>
      <p>Total requests, bandwidth, caching stats, bot traffic. Free tier included with Pages deployment.</p>
    </div>
    <div class="link-card">
      <a href="https://analytics.google.com/analytics/web/#/report/content-event-events" target="_blank">GA4 Events — Affiliate Clicks →</a>
      <p>Filter by event "affiliate_click" to see which tools get clicked most. Tracked on all /go/ pages.</p>
    </div>
  </div>

  <div class="card" style="margin-top:1.5rem">
    <div class="card-hdr"><span class="card-title">Affiliate Click Tracking Setup</span></div>
    <div style="padding:1.25rem;font-size:0.82rem;color:#64748b;line-height:1.8">
      <p>All <code style="color:#f97316">/go/[tool]/</code> pages fire a GA4 event on load:</p>
      <div class="cmd">gtag('event', 'affiliate_click', &#123; tool: '[slug]', source_path: '[referrer]' &#125;)</div>
      <p style="margin-top:0.75rem">To see in GA4: Reports → Engagement → Events → filter "affiliate_click" → Secondary dimension: Event parameter "tool"</p>
    </div>
  </div>
</div>
