...
AFFILIATE_DB = {
    ...
    "runway":           {"commission": "no program",    "status": "none",    "priority": 3, "color": "gray"},
    "grammarly":        {"commission": "$0.20 CPA",     "status": "active",  "priority": 3, "color": "green"},
    "cursor":           {"commission": "no commission (referral credit only)", "status": "none", "priority": 2, "color": "gray"},
    ...
    "hubspot":          {"commission": "active (rate unverified)", "status": "active", "priority": 3, "color": "green"},
    "synthesia":        {"commission": "active (rate unverified)", "status": "active", "priority": 3, "color": "green"},
    "speechify":        {"commission": "active (rate unverified)", "status": "active", "priority": 3, "color": "green"},
    "descript":         {"commission": "active (rate unverified)", "status": "active", "priority": 3, "color": "green"},
    "frase":            {"commission": "active (rate unverified)", "status": "active", "priority": 3, "color": "green"},
